...
ActiveRecord::Schema.define(version: 20160320040214) do
  ...
  add_index "labor_comments", ["user_id"], name: "index_labor_comments_on_user_id", using: :btree
  ...
  add_index "labor_shifts", ["user_id"], name: "index_labor_shifts_on_user_id", using: :btree
  ...
  add_index "labors", ["user_id"], name: "index_labors_on_user_id", using: :btree
